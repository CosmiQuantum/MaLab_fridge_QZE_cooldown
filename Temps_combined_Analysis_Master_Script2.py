...
from analysis_021_plot_allRR_noqick2 import QubitSpectroscopy
...
from analysis_014_temp_calcsandplots_cosmiqgpvm2 import SSFTempCalcAndPlots, combined_Qtemp_studies, RPMTempCalcAndPlots
import glob
import re
import datetime
import ast
...
from analysis_021_plot_allRR_noqick2 import PlotRR_noQick
...
base_dir_run7 = "/data/QICK_data/run7B/Silicon/Effective_Temp4/" # CEPH
...
# for 24hr AB data
target_dates_qtemps_RPM_run7 = ["2026-03-08_17-05-40"]

# To re-make and save RPM RR plots
outerFolder_qtemps_plots_RR_run7 = "/home/louduser/Molenaar/APS_2026_Data" # CEPH
...
#
# For RPM Analysis
outerFolder_qtemps_plots_run7 = "/home/louduser/Molenaar/APS_2026_Data/Rabi"
...
# ----------------------------------------------------------------------------------------------run 7----------------------------------------------------------------------------------------------------------
r7_path_prefix = "/data/QUIET/QICK_data/run7B/Silicon/Effective_Temp4/Q345" # CEPH
                #"/exp/cosmiq/data/QUIET/QICK_data/run7" # CEPH
                # "/data/QICK_data/run7" # daq01
paths_SSFmethods_run7 = [
  f"2026-03-08_17-05-40"
]
######################################################################################################################
##############################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################

path_saveplots_fits_run7 = "/home/louduser/Molenaar/APS_2026_Data/"
...
path_saveplots_ssf_qtemps_vsT_run7 = "/home/louduser/Molenaar/APS_2026_Data/Rabi" #CEPH
...
if qtemp_method_flags["Qtemps_viaSSF_ge_thresh"] or qtemp_method_flags["Qtemps_viaSSF_gmeans_thresh"] or qtemp_method_flags["Qtemps_viaSSF_with_fallback"]:
    ...
    if analysis_flags["Pe_hists_viaSSF"]:
        SSF_calcs_obj.plot_all_Qs_Pe_hists_ssf(fit_results, out_dir=path_saveplots_ssf_qtemps_vsT, bins=45, rel_err_cutoff=None,
                                                                    only_return_mu_and_sigma=True, make_plot=True, save_plot=True)
