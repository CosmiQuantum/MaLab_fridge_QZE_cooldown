            ...
            for qubit_group in f.keys():
                ...
                for dataset_name in group.keys():
                    if scaling:
                        ...
                        if data_type == 'Res' or data_type == 'Res_ge' or data_type == 'Res_ef':
                        ...
                        elif data_type == 'QSpec' or data_type == 'QSpec_ge' or data_type == 'QSpec_zeno_high_gain' or data_type == 'QSpec_ef' or data_type == 'qspec_ge':
                            target_keys = {'Dates': 'Dates', 'I': 'I', 'Q': 'Q', 'Frequencies': 'Frequencies',
                                           ...
                                           'ss_I_e': 'ss_I_e', 'ss_I_g': 'ss_I_g', 'I_shots': 'I_shots','Q_shots': 'Q_shots'}
                        elif data_type == 'QSpec_zeno':
                            target_keys = {'Dates': 'Dates', 'I': 'I', 'Q': 'Q', 'Frequencies': 'Frequencies',
                                           'I Fit': 'I Fit', 'Q Fit': 'Q Fit', 'Round Num': 'Round Num',
                                           'Batch Num': 'Batch Num', 'Recycled QFreq': 'Recycled QFreq',
                                           'Exp Config': 'Exp Config', 'Syst Config': 'Syst Config','ss_Q_e': 'ss_Q_e', 'ss_Q_g': 'ss_Q_g',
                                           'ss_I_e': 'ss_I_e', 'ss_I_g': 'ss_I_g', 'I_shots': 'I_shots','Q_shots': 'Q_shots', 'Gains': 'Gains'}
                            ...
                            target_keys = {'T1': 'T1', 'Errors': 'Errors', 'Dates': 'Dates', 'I': 'I', 'Q': 'Q',
                                           ...
                                           'Syst Config': 'Syst Config','ss_Q_e': 'ss_Q_e', 'ss_Q_g': 'ss_Q_g',
                                           'ss_I_e': 'ss_I_e', 'ss_I_g': 'ss_I_g', 'I_shots': 'I_shots','Q_shots': 'Q_shots'}
                        elif data_type == 'T1_ge_zeno':
                            target_keys = {'T1': 'T1', 'Errors': 'Errors', 'Dates': 'Dates', 'I': 'I', 'Q': 'Q',
                                       'Delay Times': 'Delay Times', 'Fit': 'Fit', 'Round Num': 'Round Num',
                                       'Batch Num': 'Batch Num', 'Exp Config': 'Exp Config',
                                       'Syst Config': 'Syst Config', 'ss_Q_e': 'ss_Q_e', 'ss_Q_g': 'ss_Q_g',
                                       'ss_I_e': 'ss_I_e', 'ss_I_g': 'ss_I_g', 'I_shots': 'I_shots',
                                       'Q_shots': 'Q_shots', 'Gains':'Gains'}
