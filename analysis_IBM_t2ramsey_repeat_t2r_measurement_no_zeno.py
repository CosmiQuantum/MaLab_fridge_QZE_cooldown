...
for qubit in qubits:
    ...
    Is1, Qs1, amps1, gains1, rounds1, delay_times1, Ig_calibration1, Ie_calibration1, Qe_calibration1, Qg_calibration1,steps = t2_vs_time.run_t2_sweep_no_zeno(exp_extension='_ge', scaling=True, return_calibration_data=True)
