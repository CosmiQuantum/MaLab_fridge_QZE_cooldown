...
# For Quiet
substudy = 'readout_gain_offset_optimization_long_sigma'#'readout_length_opt_round2'#"readout_gain_offset_optimization"
...
for QubitIndex in Qs:
    ...
    gain_range=[0.01,0.3]#res_gain[QubitIndex]]
    freq_steps = 5
    gain_steps = 5
