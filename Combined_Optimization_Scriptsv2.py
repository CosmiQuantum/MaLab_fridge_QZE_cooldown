...
# For Quiet
substudy = 'readout_gain_offset_optimization_long_sigma_short_readout_Q4_v3'#'readout_length_opt_round2'#"readout_gain_offset_optimization"
