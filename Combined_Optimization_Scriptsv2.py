...
sub_study ='run7_tests'# 'source_on_25dBDAC' #pre_AB_paper_data_still_optimizing, two_photon_peak_search, AB_Paper_Data_24hrs, ABpaperdata3rdbatch_21dB_DACatten_Q1to5_t1shots_optional
...
res_leng_vals = [1]*6
res_gain = [0.12,0.6, 0.042, 0.093, 0.17, 0.08]
...
for QubitIndex in tqdm(Qs):
    ...
    optimal_lengths = [1,1,1,1,1,1] #[5]*6#[5,4.2,8.3,7.9,7.5,6.4]
    ...
    if QubitIndex == 0:# or QubitIndex == 1 or QubitIndex == 2 or QubitIndex == 5:
         gain_range = [0.8, 1.0]
    elif QubitIndex == 1:# or QubitIndex == 4:
         gain_range = [0.05,0.1]  # Gain range in a.u.
    elif QubitIndex ==2:
         gain_range = [0.04,0.1]
    elif QubitIndex ==3:
         gain_range = [0.05,0.11]
    elif QubitIndex ==4:
         gain_range = [0.11,0.17]

    #gain_range=[0.03,0.045]#res_gain[QubitIndex]]
    freq_steps = 10
    gain_steps =10
