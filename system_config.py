...
class QICK_experiment:
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        # Qubit Configuration
        self.qubit_cfg = {
            "qubit_freq_ge": [2764, 2980, 2876, 3096, 3043.32, 3093],#[2766, 2980, 2873, 3096, 3043, 3093],  # Joyce 3/11
            ...
            "qubit_gain_ge": [0.01, 0.01, 0.03, 0.01,0.02,0.008],#[0.01, 0.01, 0.03, 0.01,0.02,0.008],
