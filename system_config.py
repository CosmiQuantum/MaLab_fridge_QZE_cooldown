...
class QICK_experiment:
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        self.qubit_cfg = {
            ...
            "qubit_gain_ge": [0.01, 0.01, 0.03, 0.01,0.02, 0.002],#[0.01, 0.01, 0.03, 0.01,0.02,0.002],
            ...
            "qubit_length_ge": 20,#5,  # 5 [us] for spec Pulse
            ...
            "pi_amp": [0.7,0.7,0.7, 0.7, 0.62, 0.5787], #Joyce 3/11
