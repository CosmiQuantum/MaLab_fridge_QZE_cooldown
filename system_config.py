    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET" or fridge == "BOB":
            ...
            self.qubit_cfg = {
                ...
                "sigma": [0.03, 0.021, 0.02, 0.013, 0.011, 0.007],  # DAC 2 04/07 [us] for Gaussian Pulse (5+10 DAC atten for qubit). Updated on 7/17 by Arianna
