...
FRIDGE = "QUIET"
qubits = [5]
path = '2d_more_stats'#'2d_test_lower_res'
ramsey_nbar_path='/bob_run_started_Aug_3_2026/squill/2d_test/run/'
...
for qubit in qubits:
    ...
    if nbar_from_ramsey:
        ...
        n_bars=t2_vs_time.run_ramsey_nbar(exp_name='StarkRamsey', save_path=f'M:/_Data/20250822 - Olivia/bob_run_started_Aug_3_2026/squill/{path}/all_qubits/analysis_new_fwhm_qspec_nbar/Ramsey_stark/',
                                              )
        ...
        q_vs_time.plot_all_q_heatmaps_nbar(amps_qspec, gains_qspec, rounds_qspec, freqs_qspec,
                                                    f'M:/_Data/20250822 - Olivia/bob_run_started_Aug_3_2026/squill/{path}/all_qubits/analysis_new_fwhm_qspec_nbar/',
