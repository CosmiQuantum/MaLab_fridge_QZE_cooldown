...
ramsey_nbar_path='/bob_run_started_Aug_23/squill/ramsey_n_bar_calibration/run/'
...
for qubit in qubits:
    ...
    if nbar_from_ramsey:
        top_folder_dates_ramsey_nbar=['2025-12-02_10-34-15']
        ...
        n_bars=t2_vs_time.run_ramsey_nbar(exp_name='StarkRamsey', save_path=f'M:/_Data/20250822 - Olivia/bob_run_started_Aug_23/squill/{path}/all_qubits/analysis_updated/',
                                              )
