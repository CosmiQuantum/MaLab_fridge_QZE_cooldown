...
for qubit in qubits:
    ...
    if nbar_from_ramsey:
        ...
        n_bars=t2_vs_time.run_ramsey_nbar(exp_name='StarkRamsey', save_path=f'M:/_Data/20250822 - Olivia/bob_run_started_Feb_11/squill/{path}/all_qubits/analysis_new_fwhm_qspec_nbar/Ramsey_stark/',
                                              )
