...
Ie_calibration_t2 = {i: [] for i in range(6)}
Ig_calibration_t2 = {i: [] for i in range(6)}
Qe_calibration_t2 = {i: [] for i in range(6)}
Qg_calibration_t2 = {i: [] for i in range(6)}
...
Ie_calibration_qspec = {i: [] for i in range(6)}
Ig_calibration_qspec = {i: [] for i in range(6)}
Qe_calibration_qspec = {i: [] for i in range(6)}
Qg_calibration_qspec = {i: [] for i in range(6)}
