...
if not os.path.exists(f"M:/_Data/20260520 - OliviaG/{run_name}/"):
    os.makedirs(f"M:/_Data/20260520 - OliviaG/{run_name}/")
if not os.path.exists(f"M:/_Data/20260520 - OliviaG/{run_name}/{device_name}/"):
    os.makedirs(f"M:/_Data/20260520 - OliviaG/{run_name}/{device_name}/")
studyFolder = os.path.join(f"M:/_Data/20260520 - OliviaG/{run_name}/{device_name}/", study)
