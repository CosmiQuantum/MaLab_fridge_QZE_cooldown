...
Qs_to_look_at = [4]# [2,3,4]#[2]#[1,2,3,4] #[2]# [0,1,2,3,4,5]     # only list the qubits you want to do the RR for

#Data saving info


# set which of the following you'd like to run to 'True'
run_flags = {"tof": False, "res_spec": True, "q_spec": False,  "ss":True, "rabi":False, "ss_gef": False, "test_act": False, "fh_rabi": False,
...
res_leng_vals = [2.5, 6, 0.9, 1.8, 1.25, 2]#[4]*6#[5, 4.2, 1.5, 7.9, 7.5, 15]  # 0.75 0.19
res_gain = [0.065, 0.8, 0.085, 0.14, 0.14, 0.08]
freq_offsets = [0,0,0,0,0,0]    #[0, 0.2, -0.05 , -0.5, -0.2, 0.0]  # [0, -0.1, -0.4 , -0.4, 0.15, 0.0]
...
run_name = 'run5' #louduser lacks the power to create a folder here so for the time being we will break storage protocol
device_name = 'Silicon'  # 'saph-6transmon'#  'sil-6transmon'
substudy_txt_notes = ('Tune Up')# ('This data was taken after reverting back to only 1 channel on the qick box. T1 shots saved as well as averaged IQ data.\n') # Initial qubit checkouts quiet run 8

################################################ Data Saving Setup ##################################################
# Folders
study = 'Res_Pulse_Test' #'fh charge dispersion' #'tests-round_robin'  #'Effective Temp' #'tests-round_robin' #qubit_checkouts
sub_study = 'testing_quspec_ssf_T1_T2'#'fh_spec_ssf_Q5' #'run7_tests' #'Q345Temp' #'run7_tests'# 'source_on_25dBDAC' #pre_AB_paper_data_still_optimizing, two_photon_peak_search, AB_Paper_Data_24hrs, ABpaperdata3rdbatch_21dB_DACatten_Q1to5_t1shots_optional
...
while j < n:
    ...
    for QubitIndex in Qs_to_look_at:
        ...
        for gain in gains:
            ...
            experiment.readout_cfg['res_gain_ge'] = gain #res_gain[QubitIndex]
